...
OperationsTypeInt *AddInt(OperationsTypeInt *a, OperationsTypeInt *b) {
    OperationsTypeInt *result =
        (OperationsTypeInt *)malloc(sizeof(OperationsTypeInt));
    result->head = a->head;
    result->value = a->value + b->value;
    return result;
}

OperationsTypeDouble *AddDouble(OperationsTypeDouble *a,
                                OperationsTypeDouble *b) {
    OperationsTypeDouble *result =
        (OperationsTypeDouble *)malloc(sizeof(OperationsTypeDouble));
    result->head = a->head;
    result->value = a->value + b->value;
    return result;
}
...
OperationsTypeDouble *SubDouble(OperationsTypeDouble *a,
                                OperationsTypeDouble *b) {
    OperationsTypeDouble *result =
        (OperationsTypeDouble *)malloc(sizeof(OperationsTypeDouble));
    result->head = a->head;
...
OperationsTypeDouble *MultDouble(OperationsTypeDouble *a,
                                 OperationsTypeDouble *b) {
    OperationsTypeDouble *result =
        (OperationsTypeDouble *)malloc(sizeof(OperationsTypeDouble));
    result->head = a->head;
...
OperationsTypeDouble *DivDouble(OperationsTypeDouble *a,
                                OperationsTypeDouble *b) {
    OperationsTypeDouble *result =
        (OperationsTypeDouble *)malloc(sizeof(OperationsTypeDouble));
    result->head = a->head;
...
OperationProto vtableInt[] = {
    ...
    (OperationProto)PrintInt,  (OperationProto)InitInt,
...
OperationsType ***MultMatrix(OperationsType ***a, OperationsType ***b,
                             size_t arows, size_t acolumns, size_t brows,
                             size_t bcolumns) {
    if (acolumns != brows) {
    ...
    OperationsType ***mult =
        (OperationsType ***)malloc(sizeof(OperationsType **) * arows);

    for (i = 0; i < arows; ++i) {
        mult[i] =
            (OperationsType **)malloc(sizeof(OperationsType *) * bcolumns);
...
void GetMinor(OperationsType ***mass, OperationsType ***minor, size_t row,
...
OperationsType *Det(OperationsType ***a, size_t rows, size_t columns) {
    ...
    if (dim == 1) {
        ...
        determinant = Add(determinant,
                          Sub(Mult(a[0][0], a[1][1]), Mult(a[0][1], a[1][0])));
        return determinant;
    } else if (dim > 2) {
        for (i = 0; i < dim; ++i) {
            ...
            if (sign > 0) {
                determinant = Add(determinant,
                                  Mult(a[i][0], Det(minor, dim - 1, dim - 1)));
            }
            if (sign < 0) {
