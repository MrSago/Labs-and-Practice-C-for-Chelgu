    ...
    switch (iMsg){
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD (wParam)) {
				...
				case IDM_LIGHTMINUS:
					if (glCurrentBitmap){
						newBitmap = GetLightMinusBitmap (glCurrentBitmap);
						UpdateCurrentBitmap(newBitmap, hwnd);
					}
					break;
				...
				case IDM_LIGHTPLUS:
					if (glCurrentBitmap) {
						newBitmap = GetLightPlusBitmap (glCurrentBitmap);
						UpdateCurrentBitmap(newBitmap, hwnd);
					}
					break;
				...
				case IDM_INV_HOR:
					if (glCurrentBitmap) {
						newBitmap = InverseHorBitmap (glCurrentBitmap);
						UpdateCurrentBitmap(newBitmap, hwnd);
					}
					break;
				...
				case IDM_INV_VER:
					if (glCurrentBitmap) {
						newBitmap = InverseVerBitmap(glCurrentBitmap);
						UpdateCurrentBitmap(newBitmap, hwnd);
					}
					break;
				...
				case IDM_ROT_LEFT:
					if (glCurrentBitmap) {
						newBitmap = LeftRotateBitmap(glCurrentBitmap);
						UpdateCurrentBitmap(newBitmap, hwnd);
					}
					break;
				...
				case IDM_ROT_RIGHT:
					if (glCurrentBitmap) {
						newBitmap = RightRotateBitmap(glCurrentBitmap);
						UpdateCurrentBitmap(newBitmap, hwnd);
					}
					break;
				...
				case IDM_SKL:
					if (glCurrentBitmap) {
						newBitmap = SklBitmap(glCurrentBitmap, hwnd, hIns);
						UpdateCurrentBitmap(newBitmap, hwnd);
					}
					break;
