...
void ReadFromFileStudents(Students Group)
{
	...
	for (size_t i = 0; i < Group->count; ++i)
	{
		...
		fscanf_s(file, "%hhu", &NewInfo[i].Age);
		...
		fscanf_s(file, "%hhu", &NewInfo[i].Object.Informatika);
		...
		fscanf_s(file, "%hhu", &NewInfo[i].Object.Algebra);
		...
		fscanf_s(file, "%hhu", &NewInfo[i].Object.Matanaliz);
		...
		fscanf_s(file, "%hhu", &NewInfo[i].Object.Fizika);
