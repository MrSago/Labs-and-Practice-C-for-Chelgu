...
void RandomStudent(Students Group)
{
	...
	printf(LIST, index + 1, NewStudent[index].LastName, NewStudent[index].FirstName, NewStudent[index].Age,
		NewStudent[index].Object.Informatika, NewStudent[index].Object.Algebra, NewStudent[index].Object.Matanaliz, NewStudent[index].Object.Fizika);
